...
namespace SystemModel.DAO
{
    ...
    public class SensorEventDAO : AbstractDAO<SensorEventTO>
    {
        private const string QUERY_INSERT_SENSOR_EVENT =
            "INSERT INTO sensor_events(EventSource, EventDescription, EventDate, EventPar1, EventPar2, EventPar3, EventPar4) VALUES " +
            "(@EventSource, @EventDescription, @EventDate, @EventPar1, @EventPar2, @EventPar3, @EventPar4); SELECT last_insert_rowid()";
